...
final enabled = Chapter(
    title: Strings.enabledTitle, description: Strings.enabledDescription);

final tariffsAndLimits = Chapter(
    title: Strings.tariffsAndLimitsTitle,
    description: Strings.tariffsAndLimitsDescription);

final interests = Chapter(
    title: Strings.interestsTitle, description: Strings.interestsDescription);
...
final List<TariffsAndLimitsButton> tarifsAndLimitsButtons = [
  ...
  TariffsAndLimitsButton(image: Images.infoImage, title: Strings.infoTitle)
];

final Map<String, bool> interstsMap = {
  Strings.food: false,
  Strings.selfDevelopment: false,
  Strings.technologies: false,
  Strings.home: false,
  Strings.leisure: false,
  Strings.care: false,
  Strings.science: false
};
